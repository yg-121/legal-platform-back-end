...
import { sendMessage, getChatHistory, getUnreadChats, markChatAsRead, startChat } from '../controllers/chatController.js';

const router = express.Router();

router.post('/start', authMiddleware(['Client']), startChat); // Add this
